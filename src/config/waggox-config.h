/* src/config/waggox-config.h.  Generated from waggox-config.h.in by configure.  */
/* src/config/waggox-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WAGGOX_CONFIG_H

#define WAGGOX_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Waggox Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Waggox Core"
...
#define PACKAGE_BUGREPORT "https://github.com/waggox/waggox/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Waggox Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Waggox Core 1.4.7"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "waggoxcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://waggox.com/"
