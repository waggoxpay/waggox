...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case ediritoshis: return QString("ediritoshis");
    ...
    else
    {
        switch(unit)
        {
            ...
            case ediritoshis: return QString("tediritoshis");
            default: return QString("???");
        }
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            ...
            case ediritoshis: return QString("Ten Nano-Waggox (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            ...
            case ediritoshis: return QString("Ten Nano-TestWaggox (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
