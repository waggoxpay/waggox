...
official/supported Docker Images found at https://hub.docker.com/r/waggox/waggoxd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/waggox/waggoxd-develop/ when changing the above text**